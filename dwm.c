...
static void saveSession(const Arg *unused);
...
/* Save the window to tag mapping in SESSION_FILE
 * Automatically invoked during planned restarts
 * Can be manually invoked by binding a hotkey to saveSession */
void
saveSession(const Arg *unused)
{
...
/* Reads from session file and places the windows in their appropriate tags */
void
restoreSession(void)
{
	// restore session
